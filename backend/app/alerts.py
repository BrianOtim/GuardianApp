...
def add_alert():
    ...
    cur.execute("INSERT INTO alerts (victimId, message) VALUES (?, ?)", (victim_id, message))
    db.commit()
    cur.close()
...
def get_alerts(user_id):
    ...
    alert_list = [{'id': alert[0], 'victimId': alert[1], 'message': alert[2]} for alert in alerts]
...
def send_email():
        recipient = 'brianangoda99@gmail.com'
        subject = 'Test Email'
